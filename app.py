...
githublink = 'https://github.com/Prerana97/ds-linear-reg-ames-housing'
...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        html.Div([
                ...
                html.Div('Fireplaces:'),
                dcc.Input(id='Fireplaces', value=0, type='number', min=0, max=1, step=1),
    ...
    html.Div('Predicted Price = (- $1,360.5K Baseline) + ($0.7K * Year Built) + ($12.7K * Bathrooms) + (- $7.7K * Bedrooms) + ($0.049K * Total Square Feet) + ($ 25.2K * Single Family Home) + (- $6.6 K * Large Neighborhood) + ($2K * Fireplaces)'),
    html.Br(),
...
def ames_lr_function(clicks, YearBuilt,Bathrooms,BedroomAbvGr,TotalSF,SingleFam,LargeNeighborhood,Fireplaces):
    if clicks==0:
        return "waiting for inputs"
    else:
        y = [-1360501.3809 + 704.4287*YearBuilt + 12738.4775*Bathrooms + -7783.1712*BedroomAbvGr + 49.824*TotalSF+ 25282.091*SingleFam+ -6637.2636*LargeNeighborhood + 2052*Fireplaces]
